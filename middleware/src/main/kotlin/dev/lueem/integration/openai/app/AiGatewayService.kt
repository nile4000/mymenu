package dev.lueem.integration.openai.app

import dev.lueem.integration.openai.api.dto.ExtractUnitRequest
import dev.lueem.integration.openai.api.dto.ExtractUnitResultItem
import dev.lueem.integration.openai.api.dto.RecipeRequest
import dev.lueem.integration.openai.domain.Recipe
...
class AiGatewayService @Inject constructor(
    ...
    companion object {
        ...
        private val RECIPE_SCHEMA_DESCRIPTION = """
